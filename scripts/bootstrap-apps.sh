...
function apply_configmaps() {
    ...
    local -r configmaps=(
        "${ROOT_DIR}/kubernetes/${CLUSTE../../../components/main/common/vars/cluster-settings.yaml"
    )
...
function apply_sops_secrets() {
    ...
    local -r secrets=(
        ...
        "${ROOT_DIR}/kubernetes/${CLUSTE../../../components/main/common/vars/cluster-secrets.sops.yaml"
